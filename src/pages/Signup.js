...
import { userSignup, setAuthToken, setUserData } from '../services/api';
    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.data.requiresOtp || result.data.userId) {
          ...
          alert('Signup successful! Please verify OTP sent to your ' + (activeTab === 'email' ? 'email' : 'mobile'));
          // You can navigate to OTP verification page
          ...
          <div className="w-full max-w-md">
            ...
            <div className="bg-[#3d4b7a]/70 backdrop-blur-md rounded-3xl p-8 shadow-2xl border border-white/10">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder={activeTab === "email" ? "example@gamil.com" : "+1 234 567 8900"}
                      required
                    />
                  </div>
                </div>
                ...
                <div>
                  <label className="block text-white text-sm mb-2">Re-Enter Password</label>
                  <div className="relative">
                    <div className="absolute left-4 top-1/2 -translate-y-1/2">
                      <svg className="w-5 h-5 text-white/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button className="bg-[#2b3654]/80 border border-[#4a5a8f] hover:bg-[#2b3654] text-white py-3 rounded-lg flex items-center justify-center gap-2 transition">
                  <svg className="w-5 h-5" viewBox="0 0 24 24">
                    <path fill="#fff" d="M17.525 9H14V7c0-1.032.084-1.682 1.563-1.682h1.868v-3.18A26.065 26.065 0 0014.693 2C11.98 2 10 3.657 10 6.699V9H7v4l3-.001V22h4v-9.003l3.066-.001L17.525 9z"/>
                  </svg>
